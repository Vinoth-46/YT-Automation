...
class ScriptEngine:
    ...
    async def generate_full_content(self, existing_topics=None, custom_topic=None):
        ...
        prompt = (
            ...
            f"4. VISUALS: Exactly 6 scenes total. For each scene, generate a 2-3 word English keyword ('visual_query') for stock video search. Every query MUST contain a technical construction word (e.g., 'construction site', 'civil engineering', 'bridge work') to ensure Pexels doesn't return unrelated lifestyle footage.\n"
