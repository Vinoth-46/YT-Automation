...
class ScriptEngine:
    ...
    async def generate_full_content(self, existing_topics=None, custom_topic=None):
        ...
        prompt = (
            ...
            f"3. SCRIPT (TAMIL): Must have a Hook (5s), Body (50s), and a CTA (5s). The TOTAL narration must be approximately 55-60 seconds long when spoken (around 130-150 words). \n"
            ...
            f"4. VISUAL STYLE PROMPT: Generate a highly descriptive English style and prompt instructions for a text-to-video AI generator (HeyGen Video Agent). It must describe the avatar's appearance (civil engineer with safety vest/hat), the engineering-themed background, visual overlays (like blueprints, technical text/numbers), and B-roll visuals matching the script facts (e.g., Giza pyramids, Burj Khalifa, concrete texture transitions).\n"
            ...
            f"  \"script\": {{\n"
            f"    \"narration\": \"...\", \n"
            f"    \"visual_style_prompt\": \"... [Descriptive 2-3 sentence visual style prompt for HeyGen]\",\n"
            f"    \"metadata\": {{\n"
