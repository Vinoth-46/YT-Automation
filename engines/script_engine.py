...
class ScriptEngine:
    ...
    async def generate_full_content(self, existing_topics=None, custom_topic=None):
        ...
        prompt = (
            ...
            f"   - A highly engaging, bold, short 2-4 word English phrase ('text_overlay') to appear on screen as a key visual cue (e.g., 'CRITICAL STEP', 'USE SAND BED', 'MISTAKE!', 'DO NOT DO THIS', 'BIG SAVINGS'). This keeps viewers hooked even without sound.\n"
