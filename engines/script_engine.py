...
class ScriptEngine:
    ...
    async def generate_full_content(self, existing_topics=None, custom_topic=None):
        ...
        prompt = (
            ...
            f"    \"scenes\": [\n"
            f"      {{\"visual_query\": \"...\", \"text_overlay\": \"...\", \"narration_tamil\": \"Tamil narration spoken during this scene (approx 20-25 words)\", \"animation\": {{\"type\": \"...\", \"title\": \"...\", \"details\": {{...}}}}}},\n"
            f"      {{\"visual_query\": \"...\", \"text_overlay\": \"...\", \"narration_tamil\": \"Tamil narration spoken during this scene (approx 20-25 words)\", \"animation\": {{\"type\": \"...\", \"title\": \"...\", \"details\": {{...}}}}}},\n"
            f"      {{\"visual_query\": \"...\", \"text_overlay\": \"...\", \"narration_tamil\": \"Tamil narration spoken during this scene (approx 20-25 words)\", \"animation\": {{\"type\": \"...\", \"title\": \"...\", \"details\": {{...}}}}}},\n"
            f"      {{\"visual_query\": \"...\", \"text_overlay\": \"...\", \"narration_tamil\": \"Tamil narration spoken during this scene (approx 20-25 words)\", \"animation\": {{\"type\": \"...\", \"title\": \"...\", \"details\": {{...}}}}}},\n"
            f"      {{\"visual_query\": \"...\", \"text_overlay\": \"...\", \"narration_tamil\": \"Tamil narration spoken during this scene (approx 20-25 words)\", \"animation\": {{\"type\": \"...\", \"title\": \"...\", \"details\": {{...}}}}}},\n"
    ...
    async def generate_script(self, topic, retry_count=0):
        ...
        prompt = (
            ...
            "  \"scenes\": [{\"visual_query\": \"specific english search term for stock video\", \"narration_tamil\": \"Tamil narration spoken during this scene\", \"animation\": {\"type\": \"comparison|ratio|structural|progress|warning\", \"title\": \"...\", \"details\": {}}}], "
