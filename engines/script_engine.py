...
class ScriptEngine:
    ...
    async def generate_full_content(self, existing_topics=None, custom_topic=None):
        ...
        prompt = (
            ...
            f"   - A highly engaging, bold, short 2-4 word Tamil phrase ('text_overlay') in Tamil script to appear on screen as a key visual cue (e.g., 'முக்கிய படி', 'மணல் படுக்கை', 'பெரிய தவறு!', 'இதை செய்யாதீர்', 'அதிக சேமிப்பு'). This keeps Tamil viewers highly hooked even without sound.\n"
