...
class ScriptEngine:
    ...
    async def generate_full_content(self, existing_topics=None, custom_topic=None):
        ...
        prompt = (
            ...
            f"4. VISUALS & SCENES: Exactly 6 scenes total. For each scene, ensure 100% ACCURATE visual alignment between what is spoken in 'narration_tamil' and the visual video prompts:\n"
            ...
            f"   - 'narration_tamil': The exact Tamil script segment spoken during this specific scene (approx 20-25 words). The concatenation of all 6 'narration_tamil' blocks must equal the overall 'narration' block.\n"
